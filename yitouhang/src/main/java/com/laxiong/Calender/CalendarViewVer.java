...
public class CalendarViewVer extends View implements Comparable {
    ...
    public int compareTo(Object another) {
        CalendarViewVer view = (CalendarViewVer) another;
    ...
    // 点击的Type
    public CalendarViewVer(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public CalendarViewVer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);

    }

    public CalendarViewVer(Context context) {
        super(context);
        init(context);
    }

    public CalendarViewVer(Context context, int style, CallBack mCallBack) {
        super(context);
    ...
    public CalendarViewVer(Context context, int style, CallBack mCallBack, CustomDate date) {
        super(context);
        CalendarViewVer.style = style;
        this.mCallBack = mCallBack;
        mShowDate = date;
...
//            clickdate = DateUtil.getNextSunday(mShowDate);    //TODO
        }
        fillDate();
    }
    @Override
...
//            clickdate = DateUtil.getNextSunday(mShowDate);  //// TODO: 2016/5/3
            fillWeekDate();
        }
...
//            if (DateUtil.isClickDay(date, mShowDate)) {    //TODO
