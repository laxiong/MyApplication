...
public class PaaCreator {
	public static JSONObject randomPaa(OrderInfo oinfo) {
		...
		try {
			...
			paaParams.put("receiveUrl",oinfo.getReceiveUrl());
			paaParams.put("version", "v1.0");
			paaParams.put("signType", "1");
			paaParams.put("merchantId",oinfo.getMerchantId());
			paaParams.put("orderNo", oinfo.getOrderNo());
			paaParams.put("orderAmount",oinfo.getOrderAmount());
			paaParams.put("orderCurrency", "0");
			paaParams.put("orderDatetime", timeStr);
			paaParams.put("productName", oinfo.getProductName());
...
//			paaParams.put("language", "3");
			paaParams.put("cardNo",oinfo.getCardNo());
		...
		String[] paaParamsArray = {
				"1","inputCharset",
				oinfo.getReceiveUrl(),"receiveUrl",
				"v1.0","version",
//				"3","language",
				"1","signType",
				oinfo.getMerchantId(),"merchantId",
				oinfo.getOrderNo(),"orderNo",
				oinfo.getOrderAmount(),"orderAmount",
				"0","orderCurrency",
				timeStr,"orderDatetime",
				oinfo.getProductName(), "productName",
//				ext1FromInput(),"ext1",
