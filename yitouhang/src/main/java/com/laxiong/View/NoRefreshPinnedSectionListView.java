...
public class NoRefreshPinnedSectionListView extends ListView {
	 ...
	 //-- inner classes
	    ...
	    public NoRefreshPinnedSectionListView(Context context, AttributeSet attrs) {
	        super(context, attrs);
	        initView();
	    }

	    public NoRefreshPinnedSectionListView(Context context, AttributeSet attrs, int defStyle) {
		...
		void createPinnedShadow(int position) {
			...
			View pinnedView = getAdapter().getView(position, pinnedShadow.view, NoRefreshPinnedSectionListView.this);
