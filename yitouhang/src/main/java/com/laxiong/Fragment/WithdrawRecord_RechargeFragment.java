 ...
 */
@SuppressLint("NewApi")
public class WithdrawRecord_RechargeFragment extends Fragment implements IViewInvest {
    /***
     * 充提页面--充值
     */
    ...
    public void initData() {
        ...
        presenter.loadInvestView(LIMIT, ++pagenow, "reg", getActivity());
    }
    public void initListener() {
        lvlist.setOnRefreshListener(new FinancingListView.OnRefreshListener() {
            ...
            public void onPullRefresh() {
                if (lvlist != null) {
                    presenter.loadInvestView(LIMIT, pagenow=1, "reg", getActivity());
