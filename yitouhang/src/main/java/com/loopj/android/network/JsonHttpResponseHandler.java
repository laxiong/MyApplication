 ...
 */
public class JsonHttpResponseHandler extends com.loopj.android.network.TextHttpResponseHandler {
...
//                                    	try {
//                                    		if (((JSONObject) jsonResponse).getInt("code") == 4401)
//                                    			LicaiApplication.getInstance().showReloginDialog();
//                                    	} catch (Exception e) {
//                                    	}
//                                    }
                                } else if (jsonResponse instanceof JSONArray) {
