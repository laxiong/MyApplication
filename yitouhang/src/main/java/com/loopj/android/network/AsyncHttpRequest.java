...
public class AsyncHttpRequest implements Runnable {
    ...
    private void makeRequest() throws IOException {
        ...
        if (responseHandler instanceof com.loopj.android.network.RangeFileAsyncHttpResponseHandler) {
            ((com.loopj.android.network.RangeFileAsyncHttpResponseHandler) responseHandler).updateRequestHeaders(request);
        }
