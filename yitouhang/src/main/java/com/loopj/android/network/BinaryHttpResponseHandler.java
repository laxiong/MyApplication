...
/**
 * Used to intercept and handle the responses from requests made using {@link com.loopj.android.network.AsyncHttpClient}.
...
public abstract class BinaryHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    private String[] mAllowedContentTypes = new String[]{
            com.loopj.android.network.RequestParams.APPLICATION_OCTET_STREAM,
            "image/jpeg",
            "image/png",
            "image/gif"
    };
    ...
    public final void sendResponseMessage(HttpResponse response) throws IOException {
        ...
        Header[] contentTypeHeaders = response.getHeaders(com.loopj.android.network.AsyncHttpClient.HEADER_CONTENT_TYPE);
